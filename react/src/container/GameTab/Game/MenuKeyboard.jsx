...
class MenuKeyboard extends React.Component {

  constructor(props) {
    super(props);
    this.state = window.nes.keyboard.player1;
  }
...
export default connect(mapStateToProps, {roomSet, gameTabSet, tabSet, keyboardSet})(MenuKeyboard);